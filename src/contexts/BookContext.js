...
//Context API
// İki yöntemle oluşturulabilir 
// Tema dil veya kullanıcıya özel özellikler vermek için kullanılır

// 1 - ) Default Value ---> this.context
// - Context nesnesini olustur
// - Baslangic Degeri Ver ve export et
// - İlgili componenta import et
// - context type yardımıyla contexti ilgili componenta ata
// - this.context yardımıyla ilgili veriye ulaş
//Sabit verilerde kullanılır.


// 2 - ) Provider -----> Consumer
// Provider ile gönderip Consumer ile alınır
// - Class comp olustur ve veriyi state içerisine koy.
// - Contexte ait Provider ile State te bulunan veriyi al
// - Parent child ilskisi {this.props.children}
// - Veriyi gondereceğin componenta Context import et.
// - Render içersinde Consumer ile Proider dan gelen veriyi yakala. 